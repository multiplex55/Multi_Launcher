...
/// On Windows, restore the window and force it to the foreground even if this
/// process does not currently own the focus.
#[cfg(target_os = "windows")]
pub fn force_restore_and_foreground(hwnd: windows::Win32::Foundation::HWND) {
    ...
    use windows::Win32::UI::WindowsAndMessaging::{
        ...
        GetWindowThreadProcessId, SetForegroundWindow, ShowWindowAsync, SW_RESTORE,
    };

    unsafe {
        let fg_hwnd: WinHWND = GetForegroundWindow();
        ...
        // Temporarily attach to the foreground thread so we can take focus
