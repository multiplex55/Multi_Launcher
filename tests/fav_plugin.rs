...
use multi_launcher::plugins::bookmarks::{BOOKMARKS_FILE, load_bookmarks, save_bookmarks};
use multi_launcher::plugins::fav::{FAV_FILE, FavEntry, FavPlugin, resolve_with_plugin, save_favs};
