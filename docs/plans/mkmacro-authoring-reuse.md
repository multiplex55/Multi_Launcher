...
| M07 | Nested calls, typed invocation and Return execution | M06 | complete | construction gates and 18 selected library tests passed; broader coverage M13/M14; commit recorded next milestone |
