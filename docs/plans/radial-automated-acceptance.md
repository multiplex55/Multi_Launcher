...
| D. Basic authoring and copied-profile acceptance | in_progress | D1 native geometry authoring passed 19/19 cases. D2 native action/style/persistence/lifecycle authoring passed 31/31 cases with cleanup and independent review. Copied-profile acceptance remains. |
